...
const getRssXml = (blogPosts) => {
	...
	return `<?xml version="1.0" ?>
      <rss version="2.0">
        <channel>
            <title>notes.marcocaldera.com</title>
            <link>https://notes.marcocaldera.com</link>
            <description>Marco Caldera</description>
	...
	blogPosts
		...
		.forEach((post) => {
          ...
          <item>
            ...
            <link>
              https://notes.marcocaldera.com/posts/${post.slug}?utm_source=rss
            </link>
